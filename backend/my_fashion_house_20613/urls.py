"""my_fashion_house_20613 URL Configuration
...
admin.site.site_header = "My Fashion House"
admin.site.site_title = "My Fashion House Admin Portal"
admin.site.index_title = "My Fashion House Admin"

# swagger
api_info = openapi.Info(
    title="My Fashion House API",
    default_version="v1",
    description="API documentation for My Fashion House App",
)
